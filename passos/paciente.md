...
Adicione a URL do paciente em usuarios.urls:

```python
path('pacientes/', views.pacientes, name='pacientes'),
```

Desenvolva a lógica do cadastro de paciente:
...
Adicione o pacientes.html em templates/
            ...
            <div class="mt-6">
                ...
                <a href="#"
                    ...
                    <div class="flex flex-col p-4 leading-normal gap-2">
                        <h5 class="text-2xl font-bold tracking-tight text-gray-900">Caio</h5>
                        <p class="font-normal text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
    ...
    <a href="#"
       class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
             ...
             alt="">
        <div class="flex flex-col p-4 leading-normal gap-2">
            <h5 class="text-2xl font-bold tracking-tight text-gray-900">Caio Sampaio</h5>
            <p class="font-normal text-gray-700">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
            <hr class="border-slate-800/20 my-2 w-full">
            <div class="flex items-center justify-between text-sm font-medium text-gray-900">
